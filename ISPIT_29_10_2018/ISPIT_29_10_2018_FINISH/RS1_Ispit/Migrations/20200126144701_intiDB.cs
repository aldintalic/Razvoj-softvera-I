    ...
    public partial class intiDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OdrzanCas_PredajePredmet_PredajePredmetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OdrzanCasDetalj", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OdrzanCasDetalj_OdjeljenjeStavka_OdjeljenjeStavkaId",
                        column: x => x.OdjeljenjeStavkaId,
                        principalTable: "OdjeljenjeStavka",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_OdrzanCasDetalj_OdrzanCas_OdrzanCasId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OdrzanCas_PredajePredmetId",
                table: "OdrzanCas",
                column: "PredajePredmetId");

            migrationBuilder.CreateIndex(
                name: "IX_OdrzanCasDetalj_OdjeljenjeStavkaId",
                table: "OdrzanCasDetalj",
                column: "OdjeljenjeStavkaId");

            migrationBuilder.CreateIndex(
                name: "IX_OdrzanCasDetalj_OdrzanCasId",
                table: "OdrzanCasDetalj",
                column: "OdrzanCasId");
